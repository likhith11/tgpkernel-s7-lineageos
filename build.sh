...
rm -f $RDIR/build/*.zip
rm -f $RDIR/build/$RAMDISKLOC/g930x/image-new.img
rm -f $RDIR/build/$RAMDISKLOC/g930x/ramdisk-new.cpio.gz
rm -f $RDIR/build/$RAMDISKLOC/g930x/split_img/boot.img-dtb
rm -f $RDIR/build/$RAMDISKLOC/g930x/split_img/boot.img-zImage
rm -f $RDIR/build/$RAMDISKLOC/g930x/image-new.img
rm -f $RDIR/build/$RAMDISKLOC/g935x/ramdisk-new.cpio.gz
rm -f $RDIR/build/$RAMDISKLOC/g935x/split_img/boot.img-dtb
rm -f $RDIR/build/$RAMDISKLOC/g935x/split_img/boot.img-zImage
rm -f $RDIR/build/$ZIPLOC/g930x/*.zip
rm -f $RDIR/build/$ZIPLOC/g930x/*.img
rm -f $RDIR/build/$ZIPLOC/g935x/*.zip
rm -f $RDIR/build/$ZIPLOC/g935x/*.img
...
echo "" > $RDIR/build/$RAMDISKLOC/g935x/ramdisk/system/.placeholder
}
...
[ -f "$RDIR/build/$ZIPLOC/g930x/boot.img" ] && zip -gq $ZIP_NAME boot.img -x "*~"
[ -f "$RDIR/build/$ZIPLOC/g935x/boot.img" ] && zip -gq $ZIP_NAME boot.img -x "*~"
[ -f "$RDIR/build/$ZIPLOC/g93xx/g930x.img" ] && zip -gq $ZIP_NAME g930x.img -x "*~"
[ -f "$RDIR/build/$ZIPLOC/g93xx/g935x.img" ] && zip -gq $ZIP_NAME g935x.img -x "*~"
...
mv -f $RDIR/build/ramdisk/g930x/image-new.img $RDIR/build/g930f.img-save
mv -f $RDIR/build/build.log $RDIR/build/build-g930f.log
rm -f $RDIR/build/build.log
MODEL=hero2lte
KERNEL_DEFCONFIG=$KERNELCONFIG-hero2lte_defconfig
...
mv -f $RDIR/build/ramdisk/g935x/image-new.img $RDIR/build/g935f.img
mv -f $RDIR/build/build.log $RDIR/build/build-g935f.log
END_TIME=`date +%s`
let "ELAPSED_TIME=$END_TIME-$START_TIME"
echo ""
echo "Total compiling time is $ELAPSED_TIME seconds"
echo ""
echo "You can now find your g930f.img in the build folder"
echo "You can now find your g935f.img in the build folder"
echo "You can now find your build-g930f.log file in the build folder"
echo "You can now find your build-g935f.log file in the build folder"
echo ""
exit
...
mv -f $RDIR/build/ramdisk/g930x/image-new.img $RDIR/build/$ZIPLOC/g930x/boot.img
mv -f $RDIR/build/build.log $RDIR/build/build-g930f.log
ZIP_DATE=`date +%Y%m%d`
ZIP_FILE_DIR=$RDIR/build/$ZIPLOC/g930x
...
mv -f $RDIR/build/ramdisk/g935x/image-new.img $RDIR/build/$ZIPLOC/g935x/boot.img
mv -f $RDIR/build/build.log $RDIR/build/build-g935f.log
ZIP_DATE=`date +%Y%m%d`
ZIP_FILE_DIR=$RDIR/build/$ZIPLOC/g935x
...
mv -f $RDIR/build/ramdisk/g930x/image-new.img $RDIR/build/$ZIPLOC/g930x/boot.img-save
mv -f $RDIR/build/build.log $RDIR/build/build-g930f.log
rm -f $RDIR/build/build.log
MODEL=hero2lte
KERNEL_DEFCONFIG=$KERNELCONFIG-hero2lte_defconfig
...
mv -f $RDIR/build/$ZIPLOC/g930x/boot.img-save $RDIR/build/$ZIPLOC/g930x/boot.img
mv -f $RDIR/build/ramdisk/g935x/image-new.img $RDIR/build/$ZIPLOC/g935x/boot.img
mv -f $RDIR/build/build.log $RDIR/build/build-g935f.log
ZIP_DATE=`date +%Y%m%d`
ZIP_FILE_DIR=$RDIR/build/$ZIPLOC/g930x
...
mv -f $RDIR/build/ramdisk/g930x/image-new.img $RDIR/build/$ZIPLOC/g93xx/g930x.img-save
mv -f $RDIR/build/build.log $RDIR/build/build-g930f.log
rm -f $RDIR/build/build.log
MODEL=hero2lte
KERNEL_DEFCONFIG=$KERNELCONFIG-hero2lte_defconfig
...
mv -f $RDIR/build/$ZIPLOC/g93xx/g930x.img-save $RDIR/build/$ZIPLOC/g93xx/g930x.img
mv -f $RDIR/build/ramdisk/g935x/image-new.img $RDIR/build/$ZIPLOC/g93xx/g935x.img
mv -f $RDIR/build/build.log $RDIR/build/build-g935f.log
ZIP_DATE=`date +%Y%m%d`
...
clear
echo "TGPKernel S7 for LinageOS Build Script v$BUILD_SCRIPT -- Kernel Version: v$VERSION_NUMBER"
echo ""
